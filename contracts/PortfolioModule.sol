...
contract PortfolioModule is ModuleBase, ReentrancyGuard {
        ...
        onlyValidAndInitializedPortfolio(_portfolio)
    {
        ...
        ) = _getRequiredComponentUnitsForIssue(_portfolio, _quantity);
    ...
    {
        return _getRequiredComponentUnitsForIssue(_portfolio, _quantity);
    }

    function _getRequiredComponentUnitsForIssue(
        IPortfolio _portfolio,
        uint256 _quantity
    )
        internal
